package com.example.tryflowbite.until

import com.example.tryflowbite.common.BuildInfo
import com.example.tryflowbite.common.http.BackendApiUrl
import com.example.tryflowbite.common.http.PathDef
import com.example.tryflowbite.common.model.RandomMessage
import com.example.tryflowbite.common.model.LoginFailure
import com.example.tryflowbite.common.model.LoginRequest
import com.example.tryflowbite.common.model.LoginSuccess
import com.example.tryflowbite.model.Msg
import com.example.tryflowbite.model.Msg.*
import com.example.tryflowbite.until.HttpHelper.ResponseDecoders.*
import tyrian.Cmd
import tyrian.http.*
import zio.Task
